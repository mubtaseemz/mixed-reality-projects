...
void setup() {
  ...
  img3 = loadImage("mark.jpg"); 
  // ZAMAN...............
  img4 = loadImage("potter2.jpg");
  //img5 = loadImage("phi.jpg");
  // ZAMAN movie.........
  myMovie = new Movie(this, "potter.mp4");
  //myMovie.play();
}
...
void draw() {
  ...
  if ((worldRecord1 < threshold) || (worldRecord2 < threshold) || (worldRecord3 < threshold)) { 
    ...
    if((worldRecord1 < worldRecord2) && (worldRecord1 < worldRecord3))
    {
      ...
      image(img1, posx, posy, width/2, height/1.4);
      // ZAMAN was here.
      //image(img2, posx+400, posy, width/3, height/3); 
      //image(img3, posx+800, posy, width/4, height/4);
    }
    if((worldRecord2 < worldRecord1) && (worldRecord2 < worldRecord3))
    {
      ...
      //myMovie.play();
      myMovie.loop();
      image(myMovie, posx, posy, width/1.5, height/2);
    }
    if((worldRecord3 < worldRecord1) && (worldRecord3 < worldRecord2))
    {
      ...
      image(img2, posx, posy, width/3, height/1.5); 
      image(img3, posx+400, posy, width/4, height/1.5);
      image(img4, posx, posy+350, width/3, height/1.5);
      //stroke(100, 0, 0);
      //noFill();
      //strokeWeight(10);
